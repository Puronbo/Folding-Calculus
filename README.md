...
## Contents
- `Folding_Calculus_Final.md` — Main paper (Markdown)
- `Folding_Calculus.pdf` — Ready-to-read PDF
- `fold_visual.py` — Generates the key 90-degree crease visualization
- `puno_utils.py` and experiment scripts — Reproducible code from the work
- Images — Plots and figures used in the paper

## How to Use
1. Open `Folding_Calculus.pdf` to read the paper.
