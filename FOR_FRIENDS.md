# FOR FRIENDS — Start Here

**Michael Grafiel Sayson Puno** spent years building a single idea:
...
1. **Everything in `0-ROOTS/` is verified** — the experiments were
   independently re-run. The numbers match. The code is minimal numpy.
